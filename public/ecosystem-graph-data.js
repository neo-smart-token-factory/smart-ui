...
(function (global) {
      ...
      const NEO_ECOSYSTEM_GRAPH_DATA = {
            ...
            nodes: [
                  ...
                  { id: 'smart-core-contracts', label: 'smart-core-contracts', type: 'component', description: 'Contratos (neo-smart-token-factory). Makefile CORE_DIR. smart-mint sync ABIs.' },
                  { id: 'smart-cli-tool', label: 'smart-cli-tool', type: 'component', description: 'nsf CLI tool. smart-mint verifica atualizações.' },
                  { id: 'state', label: 'state.json', type: 'component', description: 'Estado operacional (internal-ops). smart-mint, ops-sync.' },
                  { id: 'changelog', label: 'changelog', type: 'component', description: 'Changelog (neo-smart-token-factory/docs). ops-sync, smart-mint.' },
                  { id: 'protocol-health', label: 'protocol-health', type: 'workflow', description: 'CI: checkout smart-ui + nsf. make health.' },
                  { id: 'docs-guard', label: 'docs-guard', type: 'workflow', description: 'CI: valida docs/* e *.md em PRs do smart-ui.' },
                  { id: 'smart-mint', label: 'smart-mint', type: 'workflow', description: 'Workflow doc: sync smart-core, changelog, state; verifica nsf.' },
            ...
            edges: [
                  ...
                  { source: 'smart-ui', target: 'smart-cli-tool', label: 'CLI_DIR (Makefile)', type: 'connected' },
                  ...
                  { source: 'smart-cli-tool', target: 'smart-core-contracts', label: 'gateway (ADR)', type: 'connected' },
            ...
            notConnected: [
                  ...
                  { source: 'smart-core-contracts', target: 'smart-ui', reason: 'Sem integração direta (apenas via nsf).' },
                  { source: 'smart-core-contracts', target: 'landing', reason: 'Sem conexão.' },
                  { source: 'smart-core-contracts', target: 'docs', reason: 'Sem conexão direta.' },
