...
(function(global) {
  ...
  const NEO_ECOSYSTEM_GRAPH_DATA = {
    ...
    nodes: [
      ...
      { id: 'neo-smart-factory',  label: 'neo-smart-factory',  type: 'repo-private', description: 'Core: forge-core, forge-cli, internal-ops, changelog. Checkout via protocol-health.' },
      ...
      { id: 'forge-core',         label: 'forge-core',         type: 'component',   description: 'Contratos (neo-smart-factory). Makefile CORE_DIR. smart-mint sync ABIs.' },
      { id: 'forge-cli',          label: 'forge-cli',          type: 'component',   description: 'CLI (neo-smart-factory). smart-mint verifica atualizações.' },
      ...
      { id: 'smart-mint',         label: 'smart-mint',         type: 'workflow',    description: 'Workflow doc: sync forge-core, changelog, state; verifica forge-cli.' },
    ...
    edges: [
      ...
      { source: 'smart-ui',         target: 'forge-core',        label: 'CORE_DIR (Makefile)',type: 'connected' },
      ...
      { source: 'smart-mint',       target: 'forge-cli',         label: 'check',              type: 'workflow' },
    ...
    notConnected: [
      ...
      { source: 'forge-core', target: 'landing',    reason: 'Sem conexão.' },
