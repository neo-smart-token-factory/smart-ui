...
- Verifique a última versão do contrato em `/Users/nettomello/CODIGOS/neo-smart-factory/forge-core/contracts/`
...
- Leia `/Users/nettomello/CODIGOS/neo-smart-factory/docs/changelog.md`
- Adicione a nova alteração seguindo o padrão de nomenclatura NΞØ.
- Se for uma mudança de versão, atualize `/Users/nettomello/CODIGOS/neo-smart-factory/docs/patch-v0.5.1.md`.

### 3. Reporte de Operações (Internal Ops)
- Atualize o estado em `/Users/nettomello/CODIGOS/neo-smart-factory/internal-ops/state.json` (se existir).
- Opcionalmente, gere um snippet de marketing em `/Users/nettomello/CODIGOS/neo-smart-factory/internal-ops/marketing/` descrevendo o update.

### 4. Sincronização de Build (CLI)
- Verifique se a CLI precisa de atualização em `/Users/nettomello/CODIGOS/neo-smart-factory/forge-cli/`.
